...
const renderWithRouter = (ui: React.ReactElement, initialEntries = ['/list']) => {
  return rtlRender(
    <MemoryRouter
...
describe('Layout', () => {
  ...
  it('should highlight active link', () => {
    renderWithRouter(<Layout><div>Content</div></Layout>, ['/list']);
  ...
  it('should highlight stats link when on stats page', () => {
    renderWithRouter(<Layout><div>Content</div></Layout>, ['/stats']);
